...
- (void)showProgress:(float)progress status:(NSString*)string maskType:(SVProgressHUDMaskType)hudMaskType {
    UIView *overlaySuperview = self.overlayView.superview;
    if (overlaySuperview) {
        // Sometimes a view animates into place over this HUD. Ensure we're on top by becoming the last view in the window.
        [self.overlayView removeFromSuperview];
        [overlaySuperview addSubview:self.overlayView];
    } else {
